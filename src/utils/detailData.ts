...
export const DETAIL_DATA: Record<string, DetailItem> = {
  ...
  "career": {
    slug: "career",
    category: "Library",
    title: "Join Our Team of Passionate CXVIEW-ers",
    subtitle: "Build the future of Computer Vision and Edge AI",
    description: "At CXVIEW, we're dedicated to continuous learning and empowering every team member with truly meaningful career opportunities. We're always on the lookout for the best talents from around the globe. Are you ready to start with us?",
    metrics: [
  ...
  "cloud-integration-developer": {
    ...
    features: [],
    workflow: [],
    conclusion: "CXVIEW — WHERE VISION DRIVES IMPACTS",
    contentHtml: "<p><span><em>***Client name and identifying details have been anonymized for confidentiality.</em></span></p>\n<p><strong>Subject:</strong> AI Camera Deployment for a Fruit Drying & Export Manufacturing Plant</p>\n<p><strong>Industry</strong>: <a href=\"https://cxview.ai/industrial-manufacturing/\">Industrial Manufacturing</a></p>\n<h2><span>Client Overview</span></h2>\n<p>The client is a large-scale fruit drying and packaging factory supplying both international export markets and the domestic market. the factory operates multiple production zones including raw material storage, mixing, finishing goods warehouses, and quality controlled laboratory areas. To maintain export compliance and improve operational efficiency, the factory needed a centralized intelligence monitoring system that could simultaneously address security, safety, production accuracy, and workforce management.</p>\n<h2><span>The Challenges It Faces</span></h2>\n<p><strong>1. Workforce management at scale: </strong>The factory employs a large number of workers working in shifts. Traditional attendance methods were time consuming inaccurate, and difficult to audit. Additionally, workers entering the production zone were required to follow strict hygiene procedures, which were difficult to manually.</p>\n<p><strong>2. Vehicle & Access control: </strong>The factory receives daily inbound and outbound logistic vehicles, including delivery trucks and visitors. The management team needed a way to:</p>\n<ul>\n<li>Verify registered vehicles automatically</li>\n<li>Link vehicles identity with driver identity</li>\n<li>Prevent unauthorized access to the factory</li>\n</ul>\n<p><strong>3. Strict safety & compliance requirement: </strong>Because the factory exports to international markets, it must maintain high standard for:</p>\n<ul>\n<li>PPE compliance before entering controlled areas</li>\n<li>Worker safety inside production zones</li>\n<li>Smoke & fire safety</li>\n</ul>\n<p>➞ manual monitoring could not ensure real-time alerts or consistent compliance.</p>\n<p><strong>4. Production visibility & product counting: </strong></p>\n<p>Product movement occurs across multiple stages:</p>\n<ul>\n<li>Inspection before shipping</li>\n<li>Convey belts</li>\n<li>End-of-line packaging</li>\n<li>Pallets storage areas</li>\n</ul>\n<p>Counting was still being done manually, which led to:</p>\n<ul>\n<li>Counting errors</li>\n<li>Inventory inconsistencies</li>\n<li>Inefficient shipment tracking</li>\n</ul>\n<p><strong>5. Security & process control: </strong>Certain production areas required strict entry rules, including:</p>\n<ul>\n<li>Locker and changing room</li>\n<li>Controlled access to lab areas</li>\n<li>Restricted access corridors</li>\n</ul>\n<p>➞ The factory needed a system capable of detecting abnormal behavior such as entering from wrong door or leaving a workstation for too long.</p>\n<h2><span>The Solutions We Deliver</span></h2>\n<p>To address these challenges, CXVIEW deployed a full integrated AI Camera system across all critical operational areas.</p>\n<p><strong>1. Face Recognition Attendance & Smart Entry Gate:</strong> At the main entrance. CXVIEW installed a <a href=\"https://cxview.ai/face-recognition/\">AI Face Recognition</a> system integrated with automatic barrier gates. The system requires worker to remove masks ➝ look directly at the camera ➝ authenticate identity</p>\n<p>➥ If the identity in verified, the system automatically send a signal to open the barrier for entry or exit. This ensure fast, accurate, and fully traceable attendance.</p>\n<p><strong>2. OCR License Plate Recognition + Face Verification for Vehicles:</strong> At the factory gate, CXVIEW deployed an intelligent system that combines:</p>\n<div>\n<ul>\n<li><a href=\"https://cxview.ai/license-plate-recognition/\">License Plate Recognition</a> (OCR)</li>\n<li>Vehicle verification</li>\n<li>Driver face recognition</li>\n<li>Registered vehicle validation</li>\n</ul>\n<p>➥ When the vehicle approaches, the camera automatically detects the license plate ➝ the system check whether the vehicle is registered ➝ if everything matches, the barrier open automatically. This ensure a secure and fully automated vehicle entry process.</p>\n<p><strong>3. Smart Safety Monitoring </strong><em>(fire, smoke & falling detection)</em><strong>:</strong> CXVIEW deployed AI cameras across production areas to detect:</p>\n<ul>\n<li><a href=\"https://cxview.ai/smoke-fire-detection/\">Early signs of smoke or fire</a></li>\n<li>Workers falling or collapsing</li>\n<li><a href=\"https://cxview.ai/abnormal-behavior-detection/\">Abnormal safety incidents</a></li>\n</ul>\n<p>➥ When detected, the system instantly sends alerts to the security and operation teams, allowing rapid response and reducing risk.</p>\n<p><strong>4. PPE Detection before entering controlled areas</strong><strong>:</strong> Before entering laboratory and production zones, the system auto checks whether workers are wearing: approved clothing, safety hats, proper uniforms and shoes.</p>\n<p>➥ If the system detect non-compliance, it is immediately triggers and alert and records the incident.</p>\n<p><strong>5. Intelligent Product Counting across the production line</strong><strong>:</strong> CXVIEW implemented a multi-layer counting system covering:</p>\n<ul>\n<li>Counting Point 1: Products carried manually into trucks</li>\n<li>Counting Point 2: Products moving on conveyor belts</li>\n<li>Counting Point 3: Final boxes at the end of the conveyor</li>\n<li>Counting Point 4: Pallet counting in storage zones</li>\n</ul>\n<p>➥ This allows the factory to track production output in real-time and reduce human counting errors.</p>\n<p><strong>6. Intrusion detection & Process compliance</strong><strong>:</strong> In sensitive areas such as the locker room and lab entrance, The AI camera system detects:</p>\n<ul>\n<li>Workers entering through the wrong door</li>\n<li><a href=\"https://cxview.ai/intrusion-detection/\">Unauthorized access to restricted areas</a></li>\n<li>Movement that violates factory hygiene rules</li>\n</ul>\n<p>➥ When a violation occurs, the system capture images and sen dan alert immediately.</p>\n<p><strong>7. People counting & workstation Monitoring</strong><strong>:</strong> we also implemented intelligent monitoring across multiple areas such as: R&D rooms, Packaging areas, Finished goods warehouses, Production lines, and others. The system will track</p>\n<ul>\n<li><a href=\"https://cxview.ai/people-counting/\">Number of workers in each zone</a></li>\n<li>Workers leaving their workstation for longer the allowed</li>\n<li>Real-time workforce visibility for management</li>\n</ul>\n<div>\n<h2><span>Result & Business Impact</span></h2>\n<p>CXVIEW implemented a <strong>1-month Proof of Concept (POC)</strong> to validate system performance across critical areas. After successful results, the solution was officially deployed across the entire factory.</p>\n<p><strong>Key outcomes:</strong></p>\n<p>➤ <strong>Faster and fully automated attendance</strong></p>\n<p>➤<strong> Improve factory security and access control</strong></p>\n<p><strong>➤ Early detection of safety risks</strong></p>\n<p><strong>➤ Accurate real-time product counting</strong></p>\n<p><strong>➤ Better workforce productivity monitoring</strong></p>\n<p><strong>➤ Stronger compliance with export standards.</strong></p>\n<p><img src=\"https://cxview.ai/wp-content/uploads/2026/03/ChatGPT-Image-Mar-26-2026-01_43_43-PM-1-895x1024.png\" alt=\"\" class=\"my-6 rounded-2xl border border-white/10 max-w-full\" /></p>\n<p> </p>\n<p>______________</p>\n<p><strong>CXVIEW – WHERE VISION DRIVE IMPACTS</strong></p>\n<p>For further details, please visit our <a href=\"http://www.cxview.ai/\" target=\"_blank\">website</a> or reach out to us at <a href=\"https://www.linkedin.com/company/cxview-ai\" target=\"_blank\">LinkedIn</a>, <a href=\"https://www.facebook.com/cxview\" target=\"_blank\">Facebook</a></p>\n</div>\n</div>",
    image: "https://cxview.ai/wp-content/uploads/2026/03/ChatGPT-Image-Mar-26-2026-01_43_43-PM.png"
  },
  "our-first-christmas-together": {
    slug: "our-first-christmas-together",
    category: "Library",
    title: "Our First Christmas Together, Building More Than Just Work",
    subtitle: "Published on December 23, 2025",
    description: "At CXVIEW, culture is built in moments like these. ...",
    metrics: [
      { value: "Blog", label: "Category" },
      { value: "Dec 2025", label: "Published Date" },
      { value: "Read", label: "5 Min Read" }
    ],
    features: [],
    workflow: [],
    conclusion: "CXVIEW — WHERE VISION DRIVES IMPACTS",
    contentHtml: "<div>\n\t\t\t\t<div>\n\t\t\t\t\t<div>\n\t\t\t\t<div>\n\t\t\t\t\t\t\t\t\t<p><strong>This Christmas was special, not because of the gifts, but because it marked our first Christmas together as a Family.</strong></p><p>We shared a simple lunch, exchanged small gifts, laughed freely, and most importantly, allowed ourselves to pause. For a brief moment, we stepped away from deadlines, deliverables, and the constant momentum that defines our everyday work. In that pause, something meaningful surfaced.</p><p>What we are building together goes far beyond projects, targets, or numbers on a report. We are building trust. We are building connection. And we are building a shared journey.</p><p>In fast-growing organizations, it is easy to focus only on what comes next, what still needs to be delivered, what can be improved, what goals remain ahead. But progress is not defined by results alone. It is also shaped by how we work together, how we support one another, and how we choose to show up every day.</p><p>Every team starts somewhere.<br data-start=\"1128\" data-end=\"1131\" />Ours starts here.</p><p>It starts with presence showing up for one another not only professionally, but humanly. Listening with intention. Offering support when it is needed. Recognizing that behind every role and responsibility is a person doing their best to balance work and life. It starts with appreciating small moments. Not waiting for major milestones or big achievements to celebrate, but understanding that shared meals, quiet conversations, and moments of laughter in between tasks are what sustain energy and morale over time. And it starts with growing together, step by step. Learning through experience. Improving through reflection. Adapting through challenges. Becoming stronger, not as individuals working in parallel, but as a team moving forward together.</p><p>We are deeply grateful for the dedication that often happens behind the scenes: the late nights, the thoughtful conversations, the extra care taken when no one is watching, and the quiet moments of support team members offer one another. These efforts may not always be visible, but they are essential. They are the threads that hold everything together.</p><p>We are truly proud to walk through this journey TOGETHER.</p><p>Moments like our first Christmas celebration may appear simple on the surface, yet they play a meaningful role in shaping culture. Culture is not built through statements or policies alone. It is built in everyday actions. How people treat one another when no one is watching, how teams slow down to reconnect even when there is pressure to keep moving. These moments matter more than we often realize. They create a sense of belonging. They reinforce shared values. And they make future challenges feel lighter, because they remind us that we are not facing them alone.</p><p>Looking ahead, there will be many milestones, some carefully planned, others unexpected. There will be busy seasons, difficult decisions, and moments that test our resilience. But there will also be growth, shared successes, and new reasons to celebrate how far we have come.</p><p>As we move into 2026, our wish is simple yet meaningful that we continue to grow with intention, work with integrity, and support one another with kindness. That we remain curious, resilient, and open to learning. And that no matter how fast we move or how much we achieve, we never lose the human connection that brought us together in the first place.</p><p>Here’s to a new year of building not only just about achieving stronger results, but about becoming a stronger team, one that grows sustainably, supports its people, and moves forward together, one step and one season at a time.</p><p>MERRY CHRISTMAS & HAPPY NEW YEAR</p><p><strong>CXVIEW - Where Vision Drives Impacts</strong></p><p>#TeamCulture #Grateful #FirstChristmasTogether #BuildingTogether #PeopleFirst #CXVIEW_Family</p>\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t<div>\n\t\t\t\t\t<div>\n\t\t\t\t<div>\n\t\t\t\t\t\t\t<div>\n\t\t\t\t\t<video class=\"elementor-video\" src=\"https://cxview.ai/wp-content/uploads/2025/12/CX_MAS_2025.mp4\" controls=\"\" preload=\"metadata\" controlsList=\"nodownload\"></video>\n\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t</div>",
  ...
  "cxview-new-headquarters-hcmc": {
    ...
    workflow: [],
    conclusion: "CXVIEW — WHERE VISION DRIVES IMPACTS",
    contentHtml: "<div>\n\t\t\t\t<div>\n\t\t\t\t\t<div>\n\t\t\t\t<div>\n\t\t\t\t\t<h2>Where Vision Drives Impacts.</h2>\t\t\t\t</div>\n\t\t\t\t<div>\n\t\t\t\t\t<h2>NEW SPACE. NEW ENERGY. NEW RESPONSIBILITIES.</h2>\t\t\t\t</div>\n\t\t\t\t<div>\n\t\t\t\t\t\t\t\t\t<p><span><em>The new Head Office in HCMC serves as CXVIEW’s sole headquarters, marking a major milestone in the company’s journey toward innovation and growth.</em></span></p><p><span>On August 11th, 2025, <strong>CXVIEW</strong> officially opened its brand-new headquarters, marking a significant milestone in our journey of innovation and growth. The new office is more than just a workplace, it’s a space where creativity meets technology, and where our vision continues to drive real impacts.</span></p><p><span>With our advanced AI Video Analytics and Real-Time Intelligence Solutions for Smart Surveillance, CXVIEW reaffirms its commitment to creating smarter, safer, and more efficient environments for our clients and partners across industries.</span></p><p><span>We extend our heartfelt gratitude to our incredible team, partners, and friends who joined us on this special day and have supported us every step of the way. This rebranding and office opening symbolize not just a new chapter, but the beginning of greater possibilities and collaboration ahead. The future is bright, and we’re ready to shape it together.</span></p><p>To keep in touch, please visit our <a href=\"http://www.cxview.ai/\" target=\"_blank\">website</a> or reach out to us at <a href=\"https://www.linkedin.com/company/cxview-ai\" target=\"_blank\">LinkedIn</a>, <a href=\"https://www.facebook.com/cxview\" target=\"_blank\">Facebook</a></p><p> </p>\t\t\t\t\t\t\t\t</div>\n\t\t\t\t<div>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img src=\"https://cxview.ai/wp-content/uploads/2025/09/z7111644708447_d51be43384293927bc6a9c44bc28d1eb.jpg\" alt=\"\" class=\"my-6 rounded-2xl border border-white/10 max-w-full\" />\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t</div>",
  ...
  "message-from-the-board-of-directors": {
    ...
    workflow: [],
    conclusion: "CXVIEW — WHERE VISION DRIVES IMPACTS",
    contentHtml: "<h2><span>Message from CXVIEW Board of Directors</span></h2>\n<h3><span>At CXVIEW, we believe that <strong><em>“vision drives impact.”</em></strong></span></h3>\n<p>In a world overflowing with data yet shadowed by blind spots, our mission is to empower organizations to see clearly, understand deeply, and act instantly. We transform ordinary cameras into AI-powered decision engines, enabling enterprises to operate with clarity, safety, and precision. Across factories, retail spaces, and critical infrastructure, CXVIEW turns every frame into insight, every event into action, and every system into intelligence fueling operational excellence and strategic foresight.</p>\n<p>Yet behind every innovation stands people, the heart of our organization. At CXVIEW, we nurture a culture of integrity, collaboration, and continuous learning, where every individual is encouraged to grow, challenge limits, and innovate with purpose. Beyond business success, we are deeply committed to our social responsibility using technology and collective intelligence to create safer communities, sustainable industries, and a more connected society.</p>\n<p>Because when vision meets intelligence, and people unite around purpose, innovation becomes meaningful, and together, we drive impact for business, people, and the world we share.</p>\n<p><strong><em>From CXVIEW Board of Directors</em></strong></p>\n<h2>—</h2>\n<h2><span>OUR MISSION</span></h2>\n<p>We empower businesses with intelligent <span>monitoring & real-time insights, combining AI,</span>  edge computing, and advanced tech to enhance security, efficiency, and smart decision making.</p>\n<h2><span>OUR VISION</span></h2>\n<p>To become global solution provider in <span>AI-powered surveillance and analytics,</span> delivering smart, scalable solutions that redefine how business secure, operate, and grow.</p>\n<h2><span>CORE VALUES</span></h2>\n<ul>\n<li><strong><span>C</span></strong>onscious Innovation - We drive bold, responsible innovation guided by ethics, long-term vision, and meaningful impact, focusing not on being first, but on doing what’s right for people, communities, and the planet.</li>\n<li>e<span><strong>X</strong></span>perience with Purpose - We design solutions rooted in understanding and driven by results, leveraging technology to solve critical challenges and deliver measurable value for our clients and their stakeholders.</li>\n<li><span><strong>V</strong></span>enture Beyond Ourselves - We challenge limits, take ownership, and grow as one. True progress happens when we stretch beyond comfort zones together.</li>\n<li><strong><span>I</span></strong>ntegrity with Humility - We stay humble, grounded, and accountable. With every decision, we act with integrity aware of the responsibility we carry as builders of technology.</li>\n<li><strong><span>E</span></strong>ver - Learning Mindset - Curiosity drives us. We believe learning never ends because innovation must evolve to better serve people, communities, and the future.</li>\n<li><strong><span>W</span></strong>isdom in Responsibility - We lead with care, foresight, and purpose. We honor the power of what we create, and use it to uplift, protect, and empower</li>\n</ul>\n<p>To keep in touch, please visit our <a href=\"http://www.cxview.ai/\" target=\"_blank\">website</a> or reach out to us at <a href=\"https://www.linkedin.com/company/cxview-ai\" target=\"_blank\">LinkedIn</a>, <a href=\"https://www.facebook.com/cxview\" target=\"_blank\">Facebook</a></p>",
