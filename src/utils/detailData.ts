...
export const DETAIL_DATA: Record<string, DetailItem> = {
  ...
  "san-xuat-nha-may": {
    ...
    testimonial: {
      ...
      quote: "Since integrating ApexDX's AI Camera system, safety compliance has reached 98%, and we've detected 3 conveyor jams early, saving the company billions of VND."
    }
  },
  "kho-van-hang-hoa": {
  ...
  "ban-le-dich-vu": {
    ...
    testimonial: {
      ...
      quote: "Thanks to ApexDX's interactive heatmaps, we redesigned our promotional displays, boosting secondary counter sales by 22%."
    }
  },
  "giao-duc-dao-tao-2": {
  ...
  "benh-vien-co-so-y-te": {
    ...
    testimonial: {
      ...
      quote: "ApexDX's fall detection is vital for night shifts, allowing nursing staff to rapidly respond to post-stroke patients."
    }
  },
  ...
  "nhan-dien-khuon-mat": {
    ...
    testimonial: {
      ...
      quote: "ApexDX's Face ID replaced our old fingerprint logs. Checking in is extremely fast and we have completely eliminated attendance proxy logs."
    }
  },
  ...
  "phat-hien-khoi-chay": {
    ...
    testimonial: {
      ...
      quote: "ApexDX's AI Fire detection helped us contain a spark in our paper roll warehouse before it escalated. Truly life-saving tech."
    }
  },
  "phat-hien-xam-nhap": {
  ...
  "ban-do-nhiet-lo-trinh": {
    ...
    testimonial: {
      ...
      quote: "Thanks to ApexDX's heatmaps, we discovered two blind spots at the back of the store and converted them into tasting booths, balancing visitor traffic."
    }
  },
  ...
  "case-studies": {
    ...
    description: "A summary of custom software, AI components, and digital platforms built by ApexDX for partners across real estate, retail operations, automation, and communities.",
    metrics: [
    ...
    testimonial: {
      quote: "ApexDX's custom software modules and attentive post-deploy support have helped us automate complex manual back-office tasks, improving overall efficiency.",
      name: "Partner Management Board",
      role: "Operations Director",
      company: "ApexDX Partner Network",
      avatarInitials: "CP"
    },
    conclusion: "Real-world projects highlighting ApexDX's capacity in custom software and AI integrations."
  },
  "dieu-khoan-su-dung": {
  ...
  "career": {
    slug: "career",
    category: "Library",
    title: "Join Our Team of Passionate ApexDX-ers",
    subtitle: "Build the future of Computer Vision and Edge AI",
    description: "At ApexDX, we're dedicated to continuous learning and empowering every team member with truly meaningful career opportunities. We're always on the lookout for the best talents from around the globe. Are you ready to start with us?",
    metrics: [
