...
export const DETAIL_DATA: Record<string, DetailItem> = {
  ...
  "san-xuat-nha-may": {
    ...
    subtitle: "Optimize workplace safety and process efficiency using AI Camera System",
    description: "Industrial manufacturing environments always harbor safety hazards and operational process control challenges. Real-time AI Camera System analysis helps automate PPE compliance monitoring, control access to restricted areas, and early detect hazards on conveyor lines.",
    metrics: [
    ...
    features: [
      ...
      "Safety monitoring around forklifts and dangerous machinery",
  ...
  "kho-van-hang-hoa": {
    ...
    description: "Large warehouses and distribution centers are hard to monitor manually. Our AI Camera System solution automates gate controls, tracks cargo routes, and secures high-value storage zones.",
    metrics: [
    ...
    conclusion: "Enhance overall warehouse AI camera capability to secure enterprise assets.",
    challenges: [
  ...
  "ban-le-dich-vu": {
    ...
    description: "Go beyond basic POS transactional data. Falcon AI Camera System helps retail chains decode actual in-store shopper journeys: from store entry, aisle pathways, and product engagement to checkout.",
    metrics: [
  ...
  "khach-san-du-lich": {
    ...
    dashboardBenefits: [
      ...
      { title: "24/7 Safety Camera System", description: "Analyze skeletal postures to trigger emergency sirens if a guest falls or enters the pool after hours." },
  ...
  "benh-vien-co-so-y-te": {
    ...
    description: "In high-pressure medical environments, AI Camera System acts as a vigilant assistant. It flags patients leaving beds unsupervised, detects falls in waiting areas, and audits mask compliance in sterile zones.",
    metrics: [
  ...
  "dieu-khoan-su-dung": {
    ...
    description: "This document outlines terms, access rights, and legal obligations for users browsing our site or requesting Falcon AI Camera System consultations.",
    metrics: [
  ...
  "chinh-sach-bao-mat": {
    ...
    features: [
      ...
      "Falcon AI Camera System is processed locally at Edge Box layers",
  ...
  "cloud-integration-developer": {
    ...
    category: "Library",
    title: "Unlocking Intelligence with Falcon AI Camera System",
    subtitle: "Published on November 7, 2025",
    description: "Library | Blog | Solutions | Falcon AI Camera System ...",
    metrics: [
  ...
  "ai-video-analytics-smart-surveillence-operational-efficiency": {
    ...
    category: "Library",
    title: "Falcon AI Camera System in Smart Camera Systems & Operational Efficiency",
    subtitle: "Published on September 23, 2025",
    description: "Library | Blog | Solutions | Industrial Manufacturing ...",
    metrics: [
      { value: "Blog", label: "Category" },
  ...
  "blog": {
    ...
    description: "Stay updated with the latest trends in AI technology, real-time video analytics, and automation.",
    metrics: [],
    features: [],
    workflow: [],
    conclusion: "",
