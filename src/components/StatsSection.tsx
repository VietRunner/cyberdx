...
export default function StatsSection() {
  return (
    ...
    >
      <div className="absolute bottom-10 right-10 w-[300px] h-[300px] bg-[#f97316]/5 rounded-full blur-[120px] pointer-events-none z-0" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col items-start gap-4 mb-16 max-w-3xl text-left">
          ...
          <p className="text-white/70 text-base md:text-lg lg:text-xl leading-relaxed max-w-3xl">
            CyberDX Falcon delivers measurable results by transforming passive camera systems into real-time AI camera intelligence for business protection.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {STATS.map((stat) => {
            ...
            return (
              <div
                key={stat.label}
                className="p-8 rounded-2xl modern-glass flex flex-col justify-between min-h-[300px] text-left relative group hover:border-[#f97316]/30"
              >
                ...
                <div className="mb-4">
                  <span className="text-5xl lg:text-6xl font-black text-white font-mono tracking-tight group-hover:text-[#f97316] transition-colors duration-300">
                    {stat.value}
                  </span>
                </div>
