...
export default function WorkflowSection() {
  ...
  return (
    ...
    >
      <div className="absolute top-1/2 left-0 w-[400px] h-[400px] bg-[#f97316]/5 rounded-full blur-[140px] pointer-events-none z-0" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col items-center text-center gap-4 mb-24">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tight leading-tight">
            REAL-TIME <span className="text-[#f97316]">PROCESSING PIPELINE</span>
          </h2>
        ...
        <div className="relative">
          ...
          <motion.div
            ...
            className="absolute left-1/2 top-4 bottom-4 w-0.5 bg-gradient-to-b from-[#f97316] to-purple-600 -translate-x-1/2 hidden lg:block z-10 shadow-[0_0_10px_rgba(249, 115, 22,0.5)]"
          />
                ...
                >
                  ...
                  <div className={`w-full lg:w-1/2 ${isEven ? "lg:pr-20 text-left lg:text-right" : "lg:order-2 lg:pl-20 text-left"}`}>
                    <motion.div
                      ...
                      className="bg-white/[0.01] border border-white/5 hover:border-[#f97316]/30 transition-all duration-300 p-8 md:p-10 rounded-3xl flex flex-col gap-4 group relative overflow-hidden shadow-lg hover:shadow-[0_12px_40px_rgba(249, 115, 22,0.08)]"
                    >
                      <div className="absolute inset-0 bg-gradient-to-br from-[#f97316]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />

                      <div className={`flex items-center gap-3 ${isEven ? "lg:justify-end" : "justify-start"}`}>
                        <span className="text-xs font-bold text-[#f97316] bg-[#f97316]/10 px-3 py-1 rounded font-mono uppercase tracking-wider">
                          {step.badge}
                        </span>
                      </div>
                  ...
                  <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 hidden lg:flex items-center justify-center">
                    <motion.div
                      ...
                      className="w-16 h-16 rounded-full bg-black border-2 border-white/20 flex items-center justify-center text-white/50 font-mono font-black text-xl hover:border-[#f97316] hover:text-[#f97316] hover:scale-110 transition-all duration-300 shadow-[0_0_24px_rgba(0,0,0,0.9)] cursor-pointer"
                    >
                      {step.number}
                    </motion.div>
                  </div>
                  ...
                  <div className={`w-full lg:w-1/2 ${isEven ? "lg:order-2 lg:pl-20 text-left" : "lg:pr-20 text-left lg:text-right"}`}>
                    ...
                    >
                      <div className="w-20 h-20 rounded-2xl bg-[#f97316]/10 border border-[#f97316]/20 flex items-center justify-center text-[#f97316] shadow-[0_8px_32px_rgba(249, 115, 22,0.15)] hover:scale-110 transition-transform duration-300">
                        {step.icon}
                      </div>
                    </motion.div>
                  </div>
